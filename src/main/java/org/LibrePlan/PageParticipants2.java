...
public class PageParticipants2 extends BandeauMenu {
	...
	@FindBy(xpath = "//span[@class and contains(.,'Nom')]//parent::div//parent::td/following-sibling::td/div/input[@style='width:500px;' and contains(@class,'-invalid')]")
